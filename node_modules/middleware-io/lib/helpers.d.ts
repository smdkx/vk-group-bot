...
export declare function assertMiddleware<T>(middleware: unknown): asserts middleware is Middleware<T>;
export declare function assertMiddlewares<T>(middlewares: unknown[]): asserts middlewares is Middleware<T>[];
